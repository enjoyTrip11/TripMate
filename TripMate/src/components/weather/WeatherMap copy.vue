<template>
  <v-container fluid>
    ...
    <v-card class="map-card" max-width="400">
...
const cities = ref([
  { name: '서울', lat: 37.5665, lon: 126.9780, position: { top: '10%', left: '30%' } },
  { name: '춘천', lat: 37.8813, lon: 127.7298, position: { top: '20%', left: '40%' } },
  { name: '강릉', lat: 37.7519, lon: 128.8761, position: { top: '30%', left: '50%' } },
  { name: '청주', lat: 36.6424, lon: 127.4890, position: { top: '40%', left: '60%' } },
  { name: '울릉/독도', lat: 37.5000, lon: 130.8714, position: { top: '50%', left: '70%' } },
  { name: '수원', lat: 37.2636, lon: 127.0286, position: { top: '70%', left: '90%' } },
  { name: '안동', lat: 36.5684, lon: 128.7294, position: { top: '80%', left: '100%' } },
  { name: '대전', lat: 36.3504, lon: 127.3845, position: { top: '90%', left: '10%' } },
  { name: '전주', lat: 35.8242, lon: 127.1480, position: { top: '15%', left: '20%' } },
  { name: '대구', lat: 35.8722, lon: 128.6014, position: { top: '25%', left: '30%' } },
  { name: '광주', lat: 35.1595, lon: 126.8526, position: { top: '35%', left: '40%' } },
  { name: '목포', lat: 34.8118, lon: 126.3926, position: { top: '45%', left: '50%' } },
  { name: '여수', lat: 34.7604, lon: 127.6622, position: { top: '55%', left: '60%' } },
  { name: '부산', lat: 35.1796, lon: 129.0756, position: { top: '65%', left: '70%' } },
  { name: '울산', lat: 35.5384, lon: 129.3114, position: { top: '75%', left: '80%' } },
  { name: '제주', lat: 33.4996, lon: 126.5312, position: { top: '85%', left: '90%' } },
]);
...
.buttons {
    ...
    flex-wrap: wrap; /* 버튼이 한 줄에 다 들어가지 않으면 자동으로 다음 줄에 표시 */
    margin: 4%;
}
